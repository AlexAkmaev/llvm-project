...
bool lowerSimMachineInstrToMCInst(const MachineInstr *MI, MCInst &OutMI, AsmPrinter &AP);

bool lowerSimMachineOperandToMCOperand(const MachineOperand &MO, MCOperand &MCOp, const AsmPrinter &AP);
