...
// Holds all target specific flags that instruction info tracks.
namespace SPII {
  enum {
    Pseudo = (1 << 0),
    Load = (1 << 1),
...
public:
  ...
  void loadRegFromStackSlot(MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI, Register DestReg,
